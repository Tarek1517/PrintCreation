...
const onSubmit = async () => {
  ...
  if (response?.data) {
    toast.success(`${response?.data?.name} Product Addded Succesfully`, {
      autoclose: 1000,
    });
...
<template>
      ...
      <div class="w-1/2 flex flex-col gap-3 px-2">
        <div class="flex flex-wrap">
          <div class="w-1/3 px-2">
            <label
              for="Status"
              class="flex items-center gap-2 pt-3 cursor-pointer"
            >
              <input
                id="Status"
                type="checkbox"
              ...
              />
              <span
                class="w-4 h-4 border border-gray-600 peer-checked:bg-common peer-checked:border-common flex items-center justify-center text-white"
              >
          ...
          <div class="w-full mt-5 px-2" v-if="attachment">
            ...
            <ul class="flex items-center">
              <li>
                ...
                <label
                  for="text"
                  class="p-2 cursor-pointer border border-r-0 border-gray-500 block peer-checked:bg-common w-40 text-center"
                  >Text</label
                >
              </li>
              <li>
                ...
                <label
                  for="image"
                  class="p-2 cursor-pointer border border-gray-500 block peer-checked:bg-common w-40 text-center"
                  >Image</label
                >
              </li>
              <li>
                ...
                <label
                  for="both"
                  class="p-2 cursor-pointer border border-l-0 border-gray-500 block peer-checked:bg-common w-40 text-center"
                  >Both Text & Image</label
                >
              </li>
            </ul>
          </div>
        ...
        <div class="w-full px-2">
          ...
          <input
            type="text"
            class="p-2 bg-secondary border border-common w-full rounded"
            v-model="form.title"
          />
        </div>
        <div class="w-full flex flex-wrap">
          ...
          <div class="w-1/3 px-2">
            ...
            <input
              type="number"
              class="border border-primary p-2 rounded-md w-full"
        ...
        <div class="w-full px-2">
          ...
          <textarea
            ...
            type="text"
            class="p-2 w-full focus:outline-none focus:ring-0 focus:border-common rounded ring-0 bg-secondary border border-common shadow-md shadow-common/50 transition-all ease-in-out duration-100"
          ></textarea>
        </div>
        <div class="w-full px-2">
          ...
          <div class="flex items-end flex-wrap -mt-4">
            ...
            <button
              class="w-1/5 text-xs bg-common rounded-md py-3 px-4 text-nowrap"
              @click="addItem"
            >
              Add More
            </button>
      ...
      <div class="w-1/2 flex flex-col gap-4 px-2">
        <div class="flex">
          <div class="pr-2">
            ...
            <label
              for="cover_image"
              class="w-52 h-36 flex items-center bg-secondary justify-center gap-3 p-2 border border-dashed border-common rounded-md text-common cursor-pointer"
            >
        ...
        <div class="w-full">
          <div class="p-2 bg-secondary border border-common rounded-lg">
            ...
            <ul class="mb-2">
              ...
              <li class="text-xs">
                Allowed types: <span class="text-common"> JPG</span>,
                <span class="text-common">JPEG</span>,
                <span class="text-common">PNG</span>.
              </li>
            </ul>
  ...
  <div class="text-center pt-10">
    <button class="w-1/2 mx-auto bg-common py-2" @click="onSubmit">
      Save Product
    </button>
  </div>
</template>
